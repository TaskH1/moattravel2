...
public class AdminHouseController {
	//Declare a variable named as houseRepository of type HouseRepository
	private final HouseRepository houseRepository;
	private final HouseService houseService;
	
	//Dependency Injection, DI
	//Constructor recieve an instance of HouseRepository, and assigns this instance to the class-level variable
	...
	direction = Direction.ASC) Pageable pageable, @RequestParam(name = "keyword", required = false) String keyword){
	...
	public String register(@ModelAttribute @Validated 
			HouseRegisterForm houseRegisterForm, 
	...
	public String edit(@PathVariable(name = "id") Integer id, Model model) {
		...
		HouseEditForm houseEditForm = new HouseEditForm(
				house.getId(), house.getName(), null, house.getDescription(),
